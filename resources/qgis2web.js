...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 28,
        minZoom: 1,
        extent: [601749.904010, 5882617.325535, 749935.132202, 5960628.087376],
        projection: new ol.proj.Projection({
            code: 'EPSG:32718',
            //extent: [663520.406045, 5895139.426066, 682533.416760, 5945731.427915],
            units: 'm'
        })
    })
});
...
map.getView().fit([601749.904010, 5882617.325535, 749935.132202, 5960628.087376], map.getSize());
